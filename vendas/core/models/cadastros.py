...
class Cadastro(models.Model):
    ...
    foto_cad = models.ImageField('Foto',upload_to='cadastros/',default='cadastros/person128.png',blank=True)
   ...
   # slug = models.SlugFied('Slug', max_length=100, null=True, editable=False)
    class Meta:
...
#def pessoa_pre_save(signal,instance,sender,**kwargs):
      #  instance.slug = slugfy(instance.nome_cad)
    ...
    def get_cadastro_url(self):
        return f'/cadastro/{self.codigo_cad}'

    # clica em vendas e retorna as vendas da pessoa
    def get_sale_cadastro_url(self):
        return f'/venda/?cadastros_sale={self.codigo_cad}'
...
#signals.pre_save.connect(pessoa_pre_save,sender=Customer)